...
@section('own_style')
    ...
    <style>
        ...
        * {
        ...
        /* Tambahkan di bawah CSS sebelumnya */
        ...
        @media(max-width: 600px) {
            ...
            #aqiBox div:first-child {
                font-size: 20px !important;
            }

            #aqiBox div:last-child {
                                                ...
                                                <div class="left container2">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <label for="citySelect" class="form-label">Select City (curated)</label>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-12">
                                                    ...
                                                    <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center">
                                                        <div style="flex:1;">
                                                            <div class="summary-card" id="summaryCard">
                                                                <div id="aqiBox" class="aqi-big"
                                                                    style="background:var(--aqi-moderate); color:#000;">
                                                                ...
                                                                <div style="flex:1;">
                                                                    ...
                                                                    <div class="param-grid" id="paramGrid">
                                                                        <div class="param"><b>PM2.5</b><span
                                                                                id="avg_pm25">—</span></div>
                                                                        <div class="param"><b>PM10</b><span
                                                                                id="avg_pm10">—</span></div>
                                                                        <div class="param"><b>O₃</b><span
                                                                                id="avg_o3">—</span></div>
                                                                        <div class="param"><b>NO₂</b><span
                                                                                id="avg_no2">—</span></div>
                                                                        <div class="param"><b>SO₂</b><span
                                                                                id="avg_so2">—</span></div>
                                                                        <div class="param"><b>CO</b><span
                                                                                id="avg_co">—</span></div>
                                                                        <div class="param"><b>P (hPa)</b><span
                                                                                id="avg_p">—</span></div>
                                                                        <div class="param"><b>Avg Dist (km)</b><span
                                                                                id="avg_dist">—</span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
